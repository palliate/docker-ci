...
RUN apt update
RUN apt install -y git wget build-essential cmake capnproto libcapnp-dev pkg-config libsystemd-dev python3 python3-setuptools python3-toml python3-git python3-click python3-jinja2 xorg-dev libgtk-3-dev libappindicator3-dev graphviz node
RUN mkdir doxygen
RUN cd doxygen
